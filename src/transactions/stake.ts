...
export const validate_fields = (tx: Tx.Stake, response: ShardusTypes.IncomingTransactionResult): ShardusTypes.IncomingTransactionResult => {
...
export const keys = (tx: Tx.Stake, result: ShardusTypes.TransactionKeys): ShardusTypes.TransactionKeys => {
...
export const memoryPattern = (tx: Tx.Stake, result: ShardusTypes.TransactionKeys): ShardusTypes.ShardusMemoryPatternsInput => {
  return {
    rw: [tx.from],
    wo: [],
    on: [],
