...
export const apply = (
  ...
  // Load-bearing guard: only emergency proposals transition here, and only on a decisive tally,
  // so most committee votes apply without a status change and must not touch the index.
