...
export const apply = (
  ...
  // Load-bearing guard: status only flips once the unapply threshold is reached, so
  // below-threshold votes apply without a status change and must not touch the index.
