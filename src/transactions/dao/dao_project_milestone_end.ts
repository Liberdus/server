...
export const apply = (
  ...
  dapp.log('Applied dao_project_milestone_end tx', from.id, tx.proposalId, tx.milestoneNumber)
}

export const createFailedAppReceiptData = (tx: Tx.DaoProjectMilestoneEnd, txId: string, txTimestamp: number, reason: string): AppReceiptData => {
