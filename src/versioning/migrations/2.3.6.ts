...
export const migrate: Migration = async () => {
  console.log('migrate 2.3.6')
  nestedCountersInstance.countEvent('migrate', 'calling migrate 2.3.6')

  LiberdusFlags.versionFlags.allowZeroToll = true
  LiberdusFlags.versionFlags.minTransferAmountCheck = true
}
