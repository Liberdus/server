...
class Storage {
  ...
  async init(): Promise<void> {
    ...
    if (LiberdusFlags.NewStorageIndex) {
  ...
  async queryAccountsEntryByRanges3(
    ...
    if (isNaN(accountStartNum) || isNaN(accountEndNum) || isNaN(accountOffsetNum) || isNaN(limit) || isNaN(tsStart) || isNaN(tsEnd)) {
